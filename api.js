...
export const api = {
  ...
  // ── Debate rounds ────────────────────────────────────────────────────────
  runRound1: (sessionId) =>
    request(`/debate/${sessionId}/round/1`, { method: "POST" }),

  runRound2: (sessionId) =>
    request(`/debate/${sessionId}/round/2`, { method: "POST" }),

  runArbitre: (sessionId) =>
    request(`/debate/${sessionId}/arbitre`, { method: "POST" }),
