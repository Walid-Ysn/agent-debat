  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-10">
      ...
      <p className="text-gray-400 text-sm mb-8">
        Définissez la décision à soumettre aux deux agents IA.
      </p>
        ...
        <div>
          ...
          <div className="flex gap-3">
            {["RH", "STRATEGIE"].map((d) => (
              ...
              >
                {d === "RH" ? "👥 Ressources Humaines" : "📊 Stratégie"}
              </button>
            ))}
          </div>
        </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    {uploadStatus[f.name] === "uploading" && (
                      <span className="text-blue-400 text-xs">Indexation...</span>
                    )}
                    {uploadStatus[f.name] === "done" && (
                      <span className="text-green-400 text-xs">✓ Indexé</span>
                    )}
                    {uploadStatus[f.name] === "error" && (
